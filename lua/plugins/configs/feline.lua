...
options.mode_colors = {
   ["n"] = { "NORMAL", options.colors.green },
   ["no"] = { "N-PENDING", options.colors.green },
   ["i"] = { "INSERT", options.colors.dark_purple },
   ["ic"] = { "INSERT", options.colors.dark_purple },
   ["t"] = { "TERMINAL", options.colors.yellow },
   ["v"] = { "VISUAL", options.colors.yellow },
   ["V"] = { "V-LINE", options.colors.yellow },
   [""] = { "V-BLOCK", options.colors.yellow },
